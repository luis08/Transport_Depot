...
{
  public class FinalLetterPdfer: ARPdfLetter
  {
    ...
    #region Column Format Definition
    ...
    #endregion Column Format Definition

    public FinalLetterPdfer(Company company, Customer customer) : base(company, customer) { }

    public IEnumerable<AgingInvoice> Invoices { get; set; }

    public override PdfSharp.Pdf.PdfDocument GetPdf()
    {
      this.AddFinalNoticeFrame();
      this.AddLetterText();
    ...
    private void AddInvoiceSchedule()
    {
      ...
      var tableMaker = new InvoiceTableMaker
      {
        ...
        Page2PlusTitle = "Final Notice Invoice Schedule"
      };
    ...
    {
      var letterText = GetSetting("TransportDepot.Reports.AccountsReceivable.FinalLetterText");
    ...
    private void AddFinalNoticeFrame()
    {
      var finalNoticeFrame = this.Section.AddTextFrame();
      finalNoticeFrame.Height = "4.0cm";
      finalNoticeFrame.Width = "12.0cm";
      finalNoticeFrame.Left = ShapePosition.Center;
      finalNoticeFrame.RelativeHorizontal = RelativeHorizontal.Margin;
      finalNoticeFrame.RelativeVertical = RelativeVertical.Page;
      finalNoticeFrame.Top = "8.1cm";

      var para = finalNoticeFrame.AddParagraph("Final Notice");
