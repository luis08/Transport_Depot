...
{
  internal static class SafetyQueries
  {
    ...
    public static string UpdateDriverSafety = @"
        ...
        UPDATE [dbo].[Driver_Qualification]
            SET [Has_Application] = [S].[Has_Application]
              ...
              ,[Drivers_License_Expiration] = [S].[Drivers_License_Expiration]
              ,[Physical_Expiration] = [S].[Physical_Expiration]
              ,[Comments] = [S].[Comments]
        FROM [dbo].[Driver_Qualification] [Q]
          INNER JOIN @DriverSafety [S]
            ON ( [S].[ID] = [Q].[ID] )
    ...
    public static string DriverSafety = @"
        ...
        SELECT   [Q].[ID]
                ...
                ,[Q].[Comments]
                ,[Q].[Drivers_License_Expiration] 
                ,[Q].[Physical_Expiration] 
                ,[E].[bActive] AS [Active]
